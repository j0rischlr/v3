      ...
      <div class="movie-info-bottom">
        ...
        <div class="bottom-section">
          <div class="movie-actions">
            ...
            <button class="random-button" @click="fetchRandomMovie">
              Suivant
            </button>
          </div>
...
const fetchRandomMovie = async () => {
  ...
  try {
    const response = await $fetch(`${config.public.apiBaseUrl}/api/random-movie`)
    movie.value = response
  } catch (err) {
    error.value = 'Impossible de charger un film. Vérifiez que le backend est démarré.'
